...
export function AddPetCard({ onCreated }) {
...
export default function PetCard({ pet: initialPet, onDeleted, onUpdated }) {
  const { toast } = useToast();
