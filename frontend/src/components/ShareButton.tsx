...
export default function ShareButton({ text, url: urlProp, className = "" }: any) {
  ...
  return (
    <div ref={ref} className={`relative ${className}`}>
      ...
      {open && (
        <div
          className="absolute bottom-full left-0 mb-2 bg-[var(--bg-card)] border border-[var(--border)] rounded-lg shadow-xl z-50 flex items-center gap-1 p-2"
        ...
        >
          {platforms.map((p: any) =>
            p.instagram ? (
              <button
                ...
                className="p-2 rounded-lg hover:bg-[var(--bg-secondary)] transition-colors flex items-center justify-center"
                title="Instagram — copies text then opens Instagram"
          ...
          <button
            onClick={copyLink}
            className="p-2 rounded-lg hover:bg-[var(--bg-secondary)] transition-colors flex items-center justify-center text-[var(--text-secondary)] border-l border-[var(--border)] ml-1 pl-3"
            title="Copy link"
